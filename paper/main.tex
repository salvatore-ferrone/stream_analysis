...
\section{Results}
  ...
  \begin{figure*}
    \centering
    \includegraphics[width=\linewidth]{figures/galactic-coords-monte-carlo-009.png}
  ...
  \begin{figure*}
    \centering
    \includegraphics[width=\linewidth]{figures/monte-carlo-009-pouliasis2017pii-GCNBody-2000-milisigma-50-noisefactor-20-boxcarindexlength-shifted-0.png}
  ...
  \begin{figure*}
    \centering
    \includegraphics[width=\linewidth]{figures/Pal5_pouliasis2017pii-GCNBody_monte-carlo-009_suspects.png}
  ...
  \begin{figure*}
    \centering
    \includegraphics[width=\linewidth]{figures/monte-carlo-009-decomposition.png}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{figures/E_Lz_perturbers.png}
    \includegraphics[width=1\linewidth]{figures/mass_size_plane.png}
    \includegraphics[width=\linewidth]{figures/histogram_impact_time.png}
