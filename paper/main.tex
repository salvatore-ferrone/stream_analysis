...
\section{Results}
  ...
  \subsection*{Overview}
    ...
    Overall, across 50 simulations, we observe 73 gaps. The distribution of simulations with a given number of gaps is as follows: 
    \begin{itemize}
      \item 0 gaps in 4 simulations,
      \item 1 gap in 25 simulations,
      \item 2 gaps in 16 simulations,
      \item 3 gaps in 4 simulations,
      \item 4 gaps in 1 simulation. 
    \end{itemize} Excluding NGC~2808, we are left with 29 gaps, leading to an expected range of 0.6-1.5 gaps per simulation.
