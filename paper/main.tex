...
\section{Results}
 ...
 \subsection*{Perturber Statistics}
    ...
    \begin{figure*}
      ...
      Lastly, \citet{2012ApJ...748...20C} conceptualized the number of gaps with a statistical quantity, the rate at which gaps are created per unit stream-length. To put our results in these terms, the global cluster population has a gap creation rate on Palomar 5 of XXX.
