...
\section{Results}
 ...
 \subsection*{Perturber Statistics}
    ...
    We desire to search for some generalizable characterisitcs of the perturbers to see what contrasts them to globular clusters that do not impact the Pal5 Stream. We present a suite of figures to answer for this end in Fig.~\ref{fig:mass_size_plane}. Note that the colors of the markers and histogram bins are 
